...
import application.controllers.AmortizationScheduleController;
...
public class AmortizationScheduleLoader {
    ...
    public void openAmortizationSchedule(double loanAmount, double interestRate, int loanTerm) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/fxml/AmortizationSchedule.fxml"));
